...
export default function Footer() {
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://www.instagram.com/soldadorasintraud/", // Reemplaza con tu URL
      icon: (
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/Intraud", // Reemplaza con tu URL
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/intraud-s-a/posts/", // Reemplaza con tu URL
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@SoldadorasIntraud", // Reemplaza con tu URL
      icon: (
        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
